      ...
      <div style="margin-bottom: 24px;">
        ...
        <div style="margin-bottom: 16px;">
          ...
          <select id="settingsProvider" onchange="app.updateProviderInfo()">
            ...
            <option value="groq" ${n.provider==="groq"?"selected":""}>Groq</option>
          </select>
        </div>
